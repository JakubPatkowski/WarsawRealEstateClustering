...
class WarsawConfig:
    ...
    districts: Dict[str, Tuple[float, float]] = field(default_factory=lambda: {
    ...
    reference_areas: Dict[str, float] = field(default_factory=lambda: {
        "Bemowo": 24.95, "Bialoleka": 73.04, "Bielany": 32.30,
        "Mokotow": 35.40, "Ochota": 9.70, "Praga-Poludnie": 22.40,
        "Praga-Polnoc": 11.40, "Rembertow": 19.30, "Srodmiescie": 15.60,
        "Targowek": 24.20, "Ursus": 9.35, "Ursynow": 43.80,
        "Wawer": 79.71, "Wesola": 22.60, "Wilanow": 36.70,
        "Wlochy": 28.60, "Wola": 19.26, "Zoliborz": 8.50
    })
...
class DataConfig:
    ...
    district_price_multipliers: Dict[str, float] = field(default_factory=lambda: {
        "Srodmiescie": 1.25,
        "Mokotow": 1.15,
        "Zoliborz": 1.10,
        "Wilanow": 1.08,
...
class Settings:
    ...
    @property
    def warsaw_center(self) -> Tuple[float, float]:
        return self.warsaw.center
